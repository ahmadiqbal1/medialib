...
export default function useMediaLibrary({ name, initialValue, validationErrors, routePrefix, validationRules, translations, multiple, maxItems, maxSizeForPreviewInBytes, vapor, vaporSignedStorageUrl, uploadDomain, withCredentials, beforeUpload, afterUpload, onChange, }: Params): {
